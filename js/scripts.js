$(document).ready(function() {
    ...
    $("#contactForm").submit(function(e) {
        ...
        $("form#contactForm :input").each(function(){
            ...
            if ($(this).attr('form-required') == 'required' && ($(this).val() == null || $(this).val() == '')) {
                $(this).addClass('err');
                hasError = true
            }
        });
        ...
        var posting = $.post($form.attr("action"), inputs);

        $('#_sent_ok_').removeClass('hide');
        setTimeout(function(){
            $('#_sent_ok_').addClass('hide');
        }, 3000);
        $form[0].reset();
...
function Atropos() {
    ...
    jQuery(".fullwidthbanner iframe").length < 1 && jQuery(".fullscreenbanner iframe").length < 1 && jQuery(".fullscreenvideo").length < 1 && jQuery("body").fitVids(),
    jQuery().slider && jQuery(".price-slider").length > 0 && jQuery("#Slider2").slider(slider_config),
...
function _topNav() {
    function e() {
        jQuery("#topHead").length > 0 ? (window._headHeight = jQuery("header#topHead").outerHeight() + jQuery("header#topNav").outerHeight() - 10,
        window._headHeightSmall = 66,
        jQuery("#wrapper").css({
            "margin-top": window._headHeight + "px"
        }),
        jQuery("#topHead").removeClass("fixed").addClass("fixed"),
        jQuery("#header_shadow").length > 0 && jQuery("#header_shadow").css({
    ...
    function t() {
        ...
        jQuery("#header_shadow").length > 0 && jQuery("#header_shadow").stop().animate({
            top: window._headHeightSmall + "px"
        }, 400),
        window.topNavSmall = !0),
        ...
        window.topNavSmall = !1)
    }
    var a = !1;
    jQuery("#topMain li.dropdown > a, #topMain li.dropdown-submenu > a").bind("click", function(e) {
        "#" == jQuery(this).attr("href") && e.preventDefault(),
        e.stopPropagation(),
        jQuery(window).width() > 979 || (a = jQuery(this).parent().hasClass("resp-active"),
...
function _animate() {
    ...
    jQuery("[data-appear-progress-animation]").each(function() {
        ...
        jQuery(window).width() > 767 ? e.appear(function() {
            _delay = 1,
            e.attr("data-appear-progress-animation-delay") && (_delay = e.attr("data-appear-progress-animation-delay")),
            _delay > 1 && e.css("animation-delay", _delay + "ms"),
            e.addClass(e.attr("data-appear-progress-animation")),
            setTimeout(function() {
                e.addClass("animation-visible")
            }
            , _delay)
...
function _lightbox() {
    ...
    void jQuery(".lightbox").each(function() {
        ...
        e.data("plugin-options") && (a = jQuery.extend({}, o, t, e.data("plugin-options"))),
...
function _parallax() {
    return "undefined" == typeof jQuery.stellar ? (jQuery(".parallax").addClass("parallax-init"),
    !1) : void jQuery(window).load(function() {
    ...
    jQuery("ul.isotope-filter").each(function() {
        ...
        t.get(0) && jQuery(window).load(function() {
            ...
            e.find("a").click(function(a) {
                ...
                return e.find("li.active").removeClass("active"),
                o.parent().addClass("active"),
                t.isotope({
                    filter: i
                }),
                jQuery(".sort-source-title[data-sort-id=" + r + "] strong").html(o.html()),
                !1
            }
            )
        }
...
function _toggle() {
    ...
    jQuery("div.toggle > label").click(function(t) {
        ...
        if (i && "undefined" != typeof t.originalEvent && o.find("div.toggle.active > label").trigger("click"),
...
function _globalSearch() {
    ...
    jQuery("li.search").bind("click", function() {
        ...
        enable_scroll(),
        jQuery(this).removeClass("open")) : (enable_overlay(),
        disable_scroll(),
    ...
    jQuery(document).keydown(function(e) {
        ...
        27 == t && (jQuery("li.search, li.quick-cart").removeClass("open"),
        disable_overlay(),
        enable_scroll())
    }
    ),
    jQuery(document).bind("click", function() {
        jQuery("li.search").hasClass("open") && (jQuery("li.search, li.quick-cart").removeClass("open"),
        disable_overlay(),
        enable_scroll())
    }
    )
...
function _quickCart() {
    ...
    jQuery(document).bind("click", function() {
        jQuery("li.quick-cart").hasClass("open") && (jQuery("li.search, li.quick-cart").removeClass("open"),
        disable_overlay(),
        enable_scroll())
    }
    )
...
function resizeToCover() {
    ...
    jQuery("video, source").width(a * vid_w_orig),
    jQuery("video, source").height(a * vid_h_orig),
...
function showMap(e) {
    ...
    t.src = "https://maps.googleapis.com/maps/api/js?v=3.exp&sensor=true&callback=" + e,
...
jQuery("div.fb-like").length > 0 && (jQuery("body").append('<div id="fb-root"></div>'),
function(e, t, a) {
    var o, r = e.getElementsByTagName(t)[0];
    e.getElementById(a) || (o = e.createElement(t),
    o.id = a,
    o.src = "//connect.facebook.net/en_US/all.js#xfbml=1",
    r.parentNode.insertBefore(o, r))
}
(document, "script", "facebook-jssdk")),
jQuery("div.g-plusone").length > 0 && !function() {
    ...
    e.fn.countTo = function(t) {
        ...
        jQuery(this).each(function() {
            function a() {
                ...
                u++,
                o(d),
                "function" == typeof r.onUpdate && r.onUpdate.call(s, d),
                u >= i && (l.removeData("countTo"),
                clearInterval(c.interval),
                d = r.to,
                "function" == typeof r.onComplete && r.onComplete.call(s, d))
            }
            function o(e) {
            ...
            c.interval = setInterval(a, r.refreshInterval),
            o(d)
        }
        )
    }
...
jQuery.fn.unFitVids = function() {
    ...
    jQuery("#" + e + " .fluid-width-video-wrapper").remove(),
    jQuery("#" + e).append(t)
}
,
function(e) {
    ...
    e.fn.waitForImages = function(a, o, r) {
        var i = 0
          , n = 0;
        if (e.isPlainObject(arguments[0]) && (r = arguments[0].waitForAll,
        o = arguments[0].each,
        a = arguments[0].finished),
        a = a || e.noop,
        o = o || e.noop,
        r = !!r,
        !e.isFunction(a) || !e.isFunction(o))
        ...
        return this.each(function() {
            ...
            e.each(l, function(r, l) {
                ...
                e(u).on("load." + t + " error." + t, function(e) {
                    return n++,
                    o.call(l.element, n, i, "load" == e.type),
                    n == i ? (a.call(s[0]),
                    !1) : void 0
                }
                ),
